...
// Write output files (summary first)
fs.writeFileSync(outputIPv4, summaryBlock + ipv4_unique.join("\n"), "utf8");
fs.writeFileSync(outputIPv6, summaryBlock + ipv6_unique.join("\n"), "utf8");

// === Console output ===
console.log("=== Processing Completed ===");
console.log("Timestamp:", timestamp);
console.log("Malformed IPs found:", malformed.length);
